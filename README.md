# E-Commerce Sales Analysis — Insights & Recommendations
**Dataset: Sample Superstore | Analysis based on Python/Plotly**
...
- Sales show a clear upward trend in Q4 (Oct–Dec), with November and December being the two strongest months. There is a notable dip in January–February before sales begin recovering mid-year.

**Recommendation:**
- Capitalize on the Q4 surge with targeted promotions, optimized inventory, and marketing campaigns in October–November.
- To combat the January–February slump, introduce post-holiday clearance sales, loyalty rewards, or early-year discount events to maintain customer engagement.
...
| Furniture | $742,000 |
| Office Supplies | $719,047 (lowest) |

**Findings:**
- Technology leads with ~36% of total revenue, slightly ahead of Furniture and Office Supplies which are close competitors.

**Recommendation:**
- Double down on Technology marketing and inventory since it drives the most revenue.
- Office Supplies, while lower in sales, should be bundled with other categories (e.g., "Buy a laptop, get office supplies at a discount") to boost their volume without heavy discounting.


## 3. Sales by Sub-Category

**Top Performers:**
- Phones ($330,007), Chairs ($328,449), Storage ($223,844), Tables ($206,966), Binders ($203,413)
...
- **Lowest Profit Month: January** — $9,134
...
**Key Finding:** Furniture has high sales ($742K) but extremely low profit ($18K), indicating poor margins or heavy discounting in this category.

**By Sub-Category — Notable Losses:**
- **Tables: -$17,726** (loss-making)
- **Bookcases: -$3,473** (loss-making)
...
- For Corporate customers, consider account management strategies and volume-based loyalty programs to improve retention and margin.
- For Consumer, focus on upselling and cross-selling to increase average order value.


## 7. Sales-to-Profit Ratio Summary

All three segments have ratios between 7–9, meaning roughly $7–$9 in sales is needed to generate $1 in profit. This is a relatively low overall profit margin (~11–14%).

**Recommendation:**
- The business should target reducing discounting across loss-making sub-categories (Tables, Bookcases) and explore cost optimization to improve the overall margin.
- A profit margin target of 15–18% is a realistic improvement goal, achievable primarily by fixing the Furniture category's profitability issues.
